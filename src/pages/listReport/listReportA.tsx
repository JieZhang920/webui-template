...
/**
 * 模板页：List Report
 * headerToolbar + Filterbar + Content
 */
class ListReportA extends React.Component<any, any> {
  ...
  render() {
    const { headerOptions, screen, tablebarOptions, compositeTableConfig, tableCode } = this.state;
    return (
      <div className="list-report-page">
        ...
        >
          <IrsFilterBarConsumer
            className="list-report-page-filterbar"
