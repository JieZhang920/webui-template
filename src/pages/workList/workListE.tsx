 ...
 */
class WorkListE extends React.Component<any, any> {
  ...
  render() {
    const { headerOptions, screen, tablebarOptions, tableCode, compositeTableConfig } = this.state;
    return (
      <div className="work-list-page">
        <div className="work-list-header no-tab">
          <IrsToolbar
            title="签约记录"
            toolbarType="header"
